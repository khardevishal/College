...
var prnno=document.s.prn_no.value;
if(prnno=="")
{
alert("Enter PR.No");
document.s.prn_no.focus();
return false;
}

var rollno=document.s.roll_no.value;
if(rollno=="")
{
alert("Enter ROLL No.");
document.s.roll_no.focus();
return false;
}
}
    ...
    <!-- ********************** Header END Common**************** -->
  			...
  			<div id="pdetails">
  			 <div class="container">
  					...
  					<h2 class="mt-3">Student Personal Details</h2>
						<form action="Student_Insertion.jsp" method="post" name="s"  onsubmit="return valid()">
						<table border="3" align="center" ">
						<tr>
						<td width="192" height="49" align="left" >Type&nbsp;&nbsp;</td>
						<td width="196">
						...
						<tr>
						<td width="192" height="49" align="left" style="color: #2c83b0;">FIRSTNAME&nbsp;&nbsp;</td>
						<td width="196"><input type="text" name="firstname" /></td>
						</tr>
						<tr>
						<td width="192" height="49" align="left" style="color: #2c83b0;">MIDDLE&nbsp;&nbsp;</td>
						<td width="196"><input type="text" name="middle" /></td>
						</tr>
						<tr>
						<td width="192" height="49" align="left" style="color: #2c83b0;">LASTNAME&nbsp;&nbsp;</td>
						<td width="196"><input type="text" name="lastname" /></td>
						</tr>
                		<tr>
						<td width="192" height="49" align="left" style="color: #2c83b0;">USERNAME&nbsp;&nbsp;</td>
						<td width="196"><input type="text" name="username" /></td>
						</tr>
						<tr>
						<td width="192" height="49" align="left" style="color: #2c83b0;">DOB&nbsp;&nbsp;</td>
						<td>
						<select name="day">
						<option>day</option>
						<% for(int i=1;i<=31;i++)
                		...
                		<tr>
						<td height="49" align="left" style="color: #2c83b0;">PASSWORD&nbsp;&nbsp;</td>
						<td><input type="password" name="password" /></td>
						</tr>
						<tr>
						<td width="192" height="49" align="left" style="color: #2c83b0;">EMAIL&nbsp;&nbsp;</td>
						<td width="196"><input type="text" name="email" /></td>
						</tr>
						<tr>
						<td width="192" height="49" align="left" style="color: #2c83b0;">MOBILE NO&nbsp;&nbsp;</td>
						...
						<td width="196"><textarea rows="3" cols="25" name="address" ></textarea></td>
              			...
              			<br/>
              			<h2 style="text-align:center;">Student Academic Details</h2>
              			
              			<table class="mt-3 mb-5" border="3" align="center">
              			<tr>
						<td width="192" height="49" align="left" style="color: #2c83b0;">INFO&nbsp;&nbsp;</td>
						<td>
						<select name="branch">
						...
						<tr>
						<td width="192" height="49" align="left" style="color: #2c83b0;">PRN NO&nbsp;&nbsp;</td>
						<td width="196"><input type="text" name="prn_no" /></td>
						</tr>
							<tr>
						<td width="192" height="49" align="left" style="color: #2c83b0;">ROLL NO&nbsp;&nbsp;</td>
						<td width="196"><input type="text" name="roll_no" /></td>
						</tr>					
